...
- **`docs/github-actions-deploy.md`** — optional SSH CD after CI (`DEPLOY_VIA_CI`, secrets, VM prerequisites)
...
- **`docs/github-actions-deploy.md`** — enable **`deploy-vm`** (SSH + **`scripts/deploy.sh`**) after green CI on **`main`**
